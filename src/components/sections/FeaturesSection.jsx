      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {features.map((feature) => (
            ...
            >
              {/* Icon circle */}
              <div className="w-14 h-14 rounded-full bg-[#e8591a]/10 border border-[#e8591a]/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>

              {/* Title */}
              <h3 className="font-bold text-white text-base mb-3 tracking-tight">
                {feature.title}
              </h3>
